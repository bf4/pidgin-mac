...

{
	...
	if ( purple_util_write_data_to_file("gfire_games.xml", buf, len) ) {
		purple_notify_message(NULL, PURPLE_NOTIFY_MSG_INFO, "XFire games Download", "Will attempt to download gfire_games.xml from the Gfire server.", "Successfully downloaded gfire_games.xml", NULL, NULL);
